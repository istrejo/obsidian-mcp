...
export function registerSearchByTags(server: McpServer, config: Config): void {
  server.registerTool(
    ...
    {
      description:
        'Find notes that contain specific tags. Tags can appear in frontmatter (tags: [tag1, tag2]) or inline in the content (#tag). Searches across all configured vaults by default.',
      inputSchema: {
